...
:PROPERTIES:
:CUSTOM_ID: Resources
:header-args:amm: :tangle ./src/advent-of-code-2020/resources.sc
:END:
...
:header-args:amm: :tangle ./src/advent-of-code-2020/day1.sc
:END:
...
My answer here was 276650720.

* Day  2 – Password Philosophy
:PROPERTIES:
:CUSTOM_ID: Day--2-–-Password-Philosophy
:header-args:amm: :tangle ./src/advent-of-code-2020/day2.sc
:END:
...
This days input is easy to handle; we just want a list of strings.
#+begin_src amm
...
In my input, 519 passwords were valid according to the policy here.
...
In my input, 708 passwords were valid according to the policy here.

* Day  3 – Toboggan Trajectory
:PROPERTIES:
:CUSTOM_ID: Day--3-–-Toboggan-Trajectory
:header-args:amm: :tangle ./src/advent-of-code-2020/day3.sc
:END:
...
Same as yesterday, this input is easy to handle; we just want a list of strings.
#+begin_src amm
...
Now, this is a fairly particular problem. I don't see an obvious
...
Now the answer is obtained by setting the starting x-position to 0,
entering an x-velocity of 3 and y-velocity of 1,
and setting ~#~ as the only entity.
#+begin_src amm
...
We get an answer of 228 tees encountered here.
...
Now just multiply together the results.
#+begin_src amm
...
Here, we get the answer 6818112000.

* Day  4 – Passport Processing
:PROPERTIES:
:CUSTOM_ID: Day--4-–-Passport-Processing
:header-args:amm: :tangle ./src/advent-of-code-2020/day4.sc
:END:
...
Another string parsing problem. This time, I want the whole input
as a single string; we will break off lines as we work
(always at double line breaks.)
(Note from the future; I have a better approach than this in later
problems, using ~spans~ defined in [[Resources]].)
#+begin_src amm
...
Under this first set of rules, there were 233 valid passports in my input.
...
Under the new rules, there were 111 valid passports.

* Day  5 – Binary Boarding
:PROPERTIES:
:CUSTOM_ID: Day--5-–-Binary-Boarding
:header-args:amm: :tangle ./src/advent-of-code-2020/day5.sc
:END:
...
The input is easy today; just a list of strings.
#+begin_src amm
...
In my input, the highest seat ID is 858.
...
:header-args:amm: :tangle ./src/advent-of-code-2020/day6.sc
:END:
...
For my input, that sum was 3427.
